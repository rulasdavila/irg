namespace irg.ViewModels
{
    ...
    public class VersionViewModel : BaseViewModel
    {
        ...
        private ObservableCollection<Version> version;
        public bool isRefreshing;

        public ObservableCollection<Version> Version
        {
        ...
        private async void LoadVersion()
        {
            ...
            var list = (List<Version>)response.Result;
            this.Version = new ObservableCollection<Version>(list);
            this.IsRefreshing = false;
        }
